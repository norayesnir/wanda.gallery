import { hasInjectionContext, getCurrentInstance, reactive, toRaw, isRef, isReactive, toRef, inject, effectScope, ref, markRaw, watch, nextTick, computed, getCurrentScope, onScopeDispose, unref, toRefs, version as version$1, watchEffect, onServerPrefetch, defineComponent, h, resolveComponent, isShallow, defineAsyncComponent, shallowRef, isReadonly, mergeProps, withCtx, createVNode, useSSRContext, createTextVNode, toDisplayString, withAsyncContext, resolveDynamicComponent, Suspense, Transition, provide, onErrorCaptured, createApp } from "vue";
...
import { sanitizeStatusCode, createError as createError$1, appendResponseHeader } from "h3";
...
import { Source, visit, BREAK, Kind, print, isSelectionNode } from "graphql";
...
import { ssrRenderComponent, ssrRenderAttr, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderVNode, ssrRenderSuspense } from "vue/server-renderer";
...
const LazyAframe = defineAsyncComponent(() => import("./_nuxt/Aframe-0382bc9d.js").then((r) => r.default));
const LazyAppFooter = defineAsyncComponent(() => import("./_nuxt/AppFooter-16a5d0f3.js").then((r) => r.default));
const LazyArrow = defineAsyncComponent(() => import("./_nuxt/Arrow-6abaaf87.js").then((r) => r.default));
const LazyCompanyLogo = defineAsyncComponent(() => Promise.resolve().then(function() {
  return CompanyLogo;
}).then((r) => r.default));
const LazyContact = defineAsyncComponent(() => import("./_nuxt/Contact-d0165bda.js").then((r) => r.default));
const LazyControls = defineAsyncComponent(() => import("./_nuxt/Controls-080c51e1.js").then((r) => r.default));
const LazyControlsPopup = defineAsyncComponent(() => import("./_nuxt/ControlsPopup-3efc6766.js").then((r) => r.default));
const LazyRoom = defineAsyncComponent(() => import("./_nuxt/Room-41140714.js").then((r) => r.default));
const LazyHomepageCategorySelection = defineAsyncComponent(() => import("./_nuxt/CategorySelection-1cb514f7.js").then((r) => r.default));
const LazyHomepageHero = defineAsyncComponent(() => import("./_nuxt/Hero-97fce415.js").then((r) => r.default));
...
const LazyTemplateButton = defineAsyncComponent(() => import("./_nuxt/Button-a6363d5a.js").then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-fe05f76c.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-c20bcadb.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-bad3b852.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-1eb3452c.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-223aae1d.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-b937434b.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-cb16faca.js").then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenEmpty-e7fcdb87.js").then((r) => r.default));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenNotFound-84f1d547.js").then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-a9a5e171.js").then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-533b654f.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-a0d148cd.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-28c40edd.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-a4b6c79d.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-53b282c4.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-6a8e4890.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-d7475577.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-35844142.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-3cb3b6a4.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-215d9f42.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-79712ee1.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-7d785bea.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-26741a1f.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-06003819.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-1ac0b4e7.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-e81a78ab.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-dc8b37fa.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-1c09a3ff.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-0cb0e0b8.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-f3cdd6d2.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-dad83b3c.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-af7c9a7d.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-11084fd5.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-fed53c52.js").then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-00413029.js").then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-bbbbafaa.js").then((m) => m.default || m)
  },
  {
    name: "project-id",
    path: "/project/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-04e0dafa.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-ff6e3a35.js").then((m) => m.default || m)
  }
];
...
const CompanyLogo_vue_vue_type_style_index_0_scoped_ab7a2f9d_lang = "";
...
const Route_vue_vue_type_style_index_0_scoped_0b58f9fe_lang = "";
...
const Icon_vue_vue_type_style_index_0_scoped_cf1ec82f_lang = "";
...
const Hamburger_vue_vue_type_style_index_0_scoped_363162af_lang = "";
...
const Menu_vue_vue_type_style_index_0_scoped_13873a5d_lang = "";
...
const app_vue_vue_type_style_index_0_scoped_125e9fe5_lang = "";
const _sfc_main$1 = {};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-394b07de.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-0a2c10ac.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
