...
import "devalue";
import "klona";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils-4f475860.js";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-e37e7920.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-05dea63f.js.map
