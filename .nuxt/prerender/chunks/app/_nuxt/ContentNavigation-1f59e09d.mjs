...
import { g as useState, h as useContentDisabled, i as useAsyncData, b as useRuntimeConfig, q as queryContent, w as withContentBase, e as encodeQueryParams, d as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, f as useContentPreview, _ as __nuxt_component_0$3 } from '../server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-5658c415.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-1f59e09d.mjs.map
